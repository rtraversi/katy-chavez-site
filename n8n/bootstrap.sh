...
# ── Validate .env ──
required=(N8N_HOST N8N_ENCRYPTION_KEY ANTHROPIC_API_KEY TELEGRAM_BOT_TOKEN CLERK_SECRET_KEY CLERK_JWT_ISSUER POSTGRES_USER POSTGRES_PASSWORD POSTGRES_DB)
missing=()
